...
//            }
        ...
        */
        public bool VerifyTimestampImprint() {
            ...
            byte[] md = System.Security.Cryptography.HashAlgorithm.Create("SHA1").ComputeHash(digest);
...
//        }
        ...
        */
        public byte[] GetEncodedPKCS7(byte[] secondDigest, DateTime signingTime, ITSAClient tsaClient, byte[] ocsp) {
            ...
            if (tsaClient != null) {
                byte[] tsImprint = System.Security.Cryptography.HashAlgorithm.Create("SHA1").ComputeHash(digest);
